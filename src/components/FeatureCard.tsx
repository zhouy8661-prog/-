...
export default function FeatureCard({ clip, onOpenLightbox }: FeatureCardProps) {
  ...
  return (
    ...
    >
      {/* Media */}
      <div
        className={`relative aspect-video bg-black ${!isTouch && isVideo && !videoError ? "cursor-pointer" : ""}`}
      ...
      >
        ...
        {isVideo && !videoError && !isPlaying && !isTouch && (
        ...
        {/* Desktop hover: maximize button */}
        {isVideo && !videoError && !isTouch && (
        ...
        {/* Playing indicator with real time */}
